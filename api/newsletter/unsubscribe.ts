/**
 * GET /api/newsletter/unsubscribe?token= — one-click GDPR unsubscribe.
 *
 * Stamps unsubscribed_at for the row whose unsubscribe_token matches (idempotent:
 * an already-unsubscribed row still shows the confirmation page), then renders a
 * small on-brand HTML page. Every broadcast email carries a per-recipient link.
 *
